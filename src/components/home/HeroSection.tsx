    ...
    <section className="grid grid-cols-1 md:grid-cols-4 gap-[var(--spacing-gutter)] h-auto md:h-[400px]">
      <div className="md:col-span-3 bg-gradient-to-br from-primary-container to-secondary rounded-xl overflow-hidden relative shadow-sm p-8 flex flex-col justify-center">
        <div className="z-10 text-white max-w-lg space-y-4">
          ...
          <h1 className="font-[family-name:var(--font-headline-xl)] text-[length:var(--text-headline-xl)] font-bold text-white drop-shadow-sm">
            Thế Hệ AI<br />Sức Mạnh Mới
          </h1>
          <p className="font-[family-name:var(--font-body-lg)] text-[length:var(--text-body-lg)] text-white/90">
      ...
      <div className="flex flex-col gap-[var(--spacing-gutter)]">
        <div className="flex-1 bg-surface-container-lowest rounded-xl shadow-sm border border-outline-variant/30 p-4 flex flex-col justify-center items-center text-center group cursor-pointer hover:shadow-md transition-shadow">
          ...
          <h3 className="font-[family-name:var(--font-title-md)] text-[length:var(--text-title-md)] text-on-surface">
            Flash Sale
          </h3>
          <p className="font-[family-name:var(--font-label-spec)] text-[length:var(--text-label-spec)] text-error mt-1">
            Giảm đến 50%
          </p>
        </div>
        <div className="flex-1 bg-surface-container-lowest rounded-xl shadow-sm border border-outline-variant/30 p-4 flex flex-col justify-center items-center text-center group cursor-pointer hover:shadow-md transition-shadow">
          ...
          <p className="font-[family-name:var(--font-label-spec)] text-[length:var(--text-label-spec)] text-primary-container mt-1">
            Ưu đãi sinh viên
          </p>
        </div>
      </div>
